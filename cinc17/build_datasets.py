...
STEP = 256
# this file is used to generate the tuple for train & dev 0.9:0.1
# tuple (ecg_file_name, label)
...
def load_all(data_path):
    ...
    with open(label_file, 'r') as fid:# open REFERENCE-v3.csv and build the dataset {ecg_file_name: labels} in make_json
    ...
    for record, label in tqdm.tqdm(records):
        ...
        num_labels = ecg.shape[0] / STEP # CREATE # of Lables// Python 2.x style
